...
>[!thm] Baire纲定理 (Baire category theorem, BCT)
...
>
>分类讨论:
>I. 若$X$是紧致的Hausdorff空间, 考虑$X$的非空子集的套序列$\clos{U_1}\supset\clos{U_2}\supset\cdots$. 族$\set{\clos{U_n}}$满足有限交性质, 由$X$的紧致性$\bigcap{\clos{U_n}}$必然非空.
