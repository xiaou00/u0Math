...
>称上述条件为**Hausdorff条件**, 满足Hausdorff条件的拓扑空间$X$称作一个**Hausdorff空间**(Hausdorff space).

Hausdorff空间中有众多优越的性质, 例如

>[!theorem] 定理1 (Hausdorff空间蕴含$T_1$公理)
...
>[!theorem] 定理2
>设拓扑空间$X$满足$T_1$公理, $A$是$X$的一个子集, 则$x$是$A$的极限点当且仅当$x$的每一个邻域与$A$的交都是无限集.
