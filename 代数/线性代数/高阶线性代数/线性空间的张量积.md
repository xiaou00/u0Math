...
>[!def] 张量积
>对于线性空间$U,V$, 我们定义自由生成线性空间$\free{U\times V}$为所有形如$(u,v),u\in U,v\in V$的元素再视作朴素的基元素生成的自由线性空间$\span\mc F(U\times V)$, 其中$\mc F$为[[遗忘函子]].
>
...
\end{aligned}$$
>最终, 我们定义[[线性商空间]]$U\otimes V:=\mathrm{F}{(U\times V)}/R$, 称之为线性空间$U,V$的**张量积**(tensor product). 对于$u\in U,v\in V$, $u\otimes v:=(u,v)+R$, 称之为**纯张量**.
