...
>设$V$是复[[内积空间]] (域$\C$上的线性空间), $\mb v,\mb w\in V$, 则一定有
>$$||\mb v||\,||\mb w||\ge |\langle\mb v,\mb w\rangle|$$
...
>
>假若$\mb v\ne \mb 0, \mb w\ne \mb 0$, 考虑
>$$e_\vec v=\frac1{||\mb v||}\cdot\mb v\quad e_\vec w=\frac1{||\mb w||}\cdot\mb w$$
>(单位化), 令$\alpha=\langle e_\vec v,e_\vec w\rangle$. 根据定义有
>$$\begin{aligned}
...
=&1-|\alpha|^2\\
=&1-\left(\frac{|\langle\vec v,\vec w\rangle|}{||\vec v||\,||\vec w||}\right)^2\\
\ge&0
\end{aligned}$$
>从而$\frac{|\langle\vec v,\vec w\rangle|}{||\vec v||\,||\vec w||}\le 1\implies|\langle\vec v,\vec w\rangle|\le ||\vec v||\,||\vec w||$.
